...
public class HomeAdapterRV extends RecyclerView.Adapter<HomeAdapterRV.CustomView> {
    ...
    public void onBindViewHolder(@NonNull CustomView holder, int position) {
        ...
        if (permissionName != null) {
            ...
            } else if (permissionName.equals("ROLE_APP_INSPECTION_ENTITY_FORM_VIEW_LIST1")) {
                holder.txt_permissionTitle.setText("فرم ها");
                holder.img_permissionPic.setBackgroundResource(R.drawable.main_icon_form);

            } else if (permissionName.equals("ROLE_APP_INSPECTION_CREATE_COMPLAINT_REPORT")) {
